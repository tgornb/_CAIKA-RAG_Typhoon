...
st.set_page_config(
    page_title="UIHxBNG CAIKA-RAG-Typhoon",
    page_icon="🤖",
    layout="wide",
...
def initialize_system(model_path="models/scb10x_llama3.2-typhoon2-t1-3b-research-preview-gguf_llama3.2-typhoon2-t1-3b-q4_k_m.gguf"):
    """Initialize the UIHxBNG CAIKA-RAG-Typhoon system."""
    try:
...
with st.sidebar:
    ...
    st.markdown("<div class='sub-title' style='text-align: center;'>UIHxBNG Corporate AI Knowledge Assistant</div>", unsafe_allow_html=True)
...
# Main content area
st.markdown("<h1 class='main-title'>UIHxBNG CAIKA-RAG-Typhoon</h1>", unsafe_allow_html=True)
